...
public class _79_GasStationCircle {
	 ...
	 public int startTour(int gasAvailable[],int gasRequired[]){
	    ...
	    public int startTour1(int gasAvailable[], int gasRequired[]){
	        ...
	        _80_KadaneWrapArray kwa = new _80_KadaneWrapArray();
	        Array._80_KadaneWrapArray.Triplet t = kwa.kadaneWrap(diff);
	    ...
	    public static void main(String args[]){
	    	_79_GasStationCircle gsc = new _79_GasStationCircle();
