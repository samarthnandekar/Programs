 ...
 * 
 * Keep two arrays which keeps max from current position to right side Other array keeps max on left size which is smaller than current element
 * Once you have these two arrays from 2nd to 2nd last position keep multiplying elements at 3 arrays index position to get max product
 * Test cases
 * Negative numbers
 * 0 in the input
 */
public class _84_IncreasSubseqOfLen3WithMaxProd {
    ...
    public static void main(String args[]){
        ...
        _84_IncreasSubseqOfLen3WithMaxProd iss = new _84_IncreasSubseqOfLen3WithMaxProd();
