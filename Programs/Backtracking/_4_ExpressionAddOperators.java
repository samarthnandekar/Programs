 ...
 */
public class _4_ExpressionAddOperators {

	public static void main(String[] args) {
		
		String inputStr="434";
		int target=-8;
		List<String> res= addOperators_1(inputStr,target);
		printResult(res);
		System.out.println("**********************");
		
		inputStr="000123";
		target=6;
		res= addOperators_1(inputStr,target);
		printResult(res);
		System.out.println("**********************");
	...
	static public List<String> addOperators_1(String num, int target) {
