...
/*
 ...
 Given a 2D matrix of 0s and 1s. Find largest rectangle of all 1s in this matrix.
  ...
  2) Copy first row to this temp array and find largest rectangular area
  ...
  Space complexity - O(cols) - if number of cols is way higher than rows then do this process for rows and not columns.
  
  References:- http://www.careercup.com/question?id=6299074475065344
...
public class Maximum_Size_Rectangle_SubmatrixOf1s {
    ...
    public static void main(String args[]){
        int input[][] = {{1,1,1,0},
                         ...
                         {1,0,0,1},
                         {1,1,1,1}};
        Maximum_Size_Rectangle_SubmatrixOf1s mrs = new Maximum_Size_Rectangle_SubmatrixOf1s();
