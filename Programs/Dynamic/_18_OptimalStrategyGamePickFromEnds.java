...
/*
 * https://www.youtube.com/watch?v=WxpIHvsu1RI&list=PLrmLmBdmIlpsHaNTPP_jHHDx_os9ItYXr&index=28
 * https://github.com/mission-peace/interview/blob/master/src/com/interview/dynamic/NPotGold.java
 * 
 */
public class _18_OptimalStrategyGamePickFromEnds {
	 ...
	 static class Pair{
	    ...
	    public static void main(String args[]){
	    	_18_OptimalStrategyGamePickFromEnds npg = new _18_OptimalStrategyGamePickFromEnds();
	        int pots[] = {3,1,5,6,2,9,3};
	        int pots1[] = {3,9,1,2};
	        Pair[][] moves = npg.findMoves(pots1);
	        for(int i=0; i < moves.length; i++){
	            for(int j=0; j < moves[i].length; j++){
