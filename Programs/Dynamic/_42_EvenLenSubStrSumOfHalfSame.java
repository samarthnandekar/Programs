 ...
 * 
 */
public class _42_EvenLenSubStrSumOfHalfSame {
    ...
    public static void main(String args[]){
        ...
        int input1[] = {1,5,3,8,0};
        _42_EvenLenSubStrSumOfHalfSame lel = new _42_EvenLenSubStrSumOfHalfSame();
        System.out.println(lel.findMaxLength(input1));
