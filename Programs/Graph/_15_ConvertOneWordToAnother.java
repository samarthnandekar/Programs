...
/*
  Given two words of equal length, for example cat and did , find words in dictionary convert one word to another one letter at a time
 * in such a way that all intermediate words are present in the dictionary
 */
public class _15_ConvertOneWordToAnother {
	 ...
	 public void convert(String word1, String word2, Set<String> dict) {
	    ...
	    public static void main(String args[]){
	        ...
	        dictionary.add("pid");
	        dictionary.add("did");
	        _15_ConvertOneWordToAnother cow = new _15_ConvertOneWordToAnother();
