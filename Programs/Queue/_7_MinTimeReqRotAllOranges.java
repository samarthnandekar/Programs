...
Input:  arr[][C] = { {2, 1, 0, 2, 1},
                     {1, 0, 1, 2, 1},
                     {1, 0, 0, 2, 1}};
Output:- All oranges can become rotten in 2 time frames.
...
Practice Tags : Amazon, Accolite, Microsoft
...
…….. (i) Dequeue an orange from the queue, rot all adjacent oranges. While rotting the adjacent, make sure that the time frame is incremented 
         only once. And the time frame is not incremented if there are no adjacent oranges.
 ...
 */
public class _7_MinTimeReqRotAllOranges {
    ...
    { 
        ...
        while(!Q.isEmpty()) 
        { 
            // This flag is used to determine whether even a single fresh orange gets rotten due to rotten oranges in the current time 
