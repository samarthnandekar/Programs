...
/**
.Given an input string S write a function which returns true if it satisfies S = nT. Basically you have to find if a given string can be
represented from a substring by iterating it �n� times. n >= 2

An example would suffice, Function should return true if
1) S = abab
2) S = abcdabcd
3) S = abcabcabc
4) S = zzxzzxzzx
...
public class _11_NTMatch {

	public static void main(String[] args) {
		_11_NTMatch ntMatch = new _11_NTMatch();
	     System.out.println(ntMatch.match("baac".toCharArray()));
	     System.out.println(ntMatch.match("abcaabca".toCharArray()));
	     System.out.println(ntMatch.match("aabbaabb".toCharArray()));
