...
class Nodes_Swapped_Correct_BST
{
    ...
    /* A function to fix a given BST where two nodes are swapped. This function  uses correctBSTUtil() to 
     find out two nodes and swaps the nodes to fix the BST */
    ...
    public static void main (String[] args) 
    {
        ...
        */
        ...
        Nodes_Swapped_Correct_BST tree = new Nodes_Swapped_Correct_BST();
