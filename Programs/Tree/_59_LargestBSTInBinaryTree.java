 ...
 * 
 */
public class _59_LargestBSTInBinaryTree {
	 ...
	 public int largestBST(Node root){
	    ...
	    private MinMax largest(Node root){
	        ...
	        //if either of left or right subtree says its not BST or the data of this node is not greater/equal than max of left and less 
	        //than min of right then subtree with this node as root will not be BST. Return false and max size of left and right subtree to parent
	    ...
	    public static void main(String args[]){
	    	_59_LargestBSTInBinaryTree lbi = new _59_LargestBSTInBinaryTree();
